...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--max-examples", type=int, default=None, help="Maximum number of examples to evaluate (default: all)"
    )
...
def main() -> None:
    ...
    print(
        f"Category 1 (correct format and answer): {metrics['category_1_correct_format_and_answer']['count']} ({metrics['category_1_correct_format_and_answer']['percentage']}%)"
    )
    print(
        f"Category 2 (correct format, wrong answer): {metrics['category_2_correct_format_wrong_answer']['count']} ({metrics['category_2_correct_format_wrong_answer']['percentage']}%)"
    )
    print(
        f"Category 3 (wrong format and answer): {metrics['category_3_wrong_format_and_answer']['count']} ({metrics['category_3_wrong_format_and_answer']['percentage']}%)"
    )
    print("=== End Metrics ===\n")
